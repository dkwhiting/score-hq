...
const Loading = ({message}) => {
  return (
    <div className="h-full w-full relative items-center justify-items block p-6 bg-gray-900/90">
      <div role="status" class="flex flex-col gap-6 justify-center items-center absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
