...
const NewGameModal = ({setShowNewGameModal}) => {
  ...
  return (
    <div className="w-screen h-screen bg-black/25 flex items-center justify-center">
      <div className="p-6 bg-white dark:bg-slate-600 w-full h-full md:h-2/3 md:w-2/3 flex flex-col justify-between">
        ...
        <div className='h-full flex flex-col'>
          <form className="flex flex-col gap-4 h-full" onKeyDown={(e)=> e.key === 'Enter' ? e.preventDefault() : null} onSubmit={(e) => handleSubmit(e)}>
            ...
            <button className='text-xl font-extrabold rounded-lg p-3 dark:bg-emerald-500 justify-self-end' type="submit">Play</button>
          </form>
        </div>
      </div>
    </div>
